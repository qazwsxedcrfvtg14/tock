...
use kernel::hil;
use kernel::hil::symmetric_encryption::{AES128Ctr, AES128, AES128CBC, AES128CCM, AES128ECB};
...
impl<A: AES128<'static> + AES128Ctr + AES128CBC + AES128ECB + AES128CCM<'static>> Component
    for AesDriverComponent<A>
{
    type StaticInput = (
